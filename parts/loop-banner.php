...
?>
<script type="text/javascript">jQuery('.listing').slick({ slidesToShow: <?php echo $slidesToShow; ?>, slidesToScroll: <?php echo $slidesToShow; ?>, dots: <?php echo $dots; ?>, arrows: <?php echo $arrows; ?>, infinite: <?php echo $infinite; ?>, autoplay: <?php echo $autoPlay; ?>, autoplaySpeed: <?php echo $autoplaySpeed; ?>, speed: <?php echo $speed; ?>, vertical: <?php echo $vertical; ?>, fade: <?php echo $fade; ?>}).addClass('tricky');</script>